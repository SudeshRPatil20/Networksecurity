...
class DataTransformation:
    ...
    def get_data_transformed_object(cls) -> Pipeline:
        ...
        logging.info("Enter get_data_transformation_object methord of transformation class")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            transformed_input_trained_feature=preprocessor_object.transform(input_feature_train_df)
            transformed_input_test_feature=preprocessor_object.transform(input_feature_test_df)
            
            train_arr=np.c_[transformed_input_trained_feature, np.array(target_feature_train_df) ]
