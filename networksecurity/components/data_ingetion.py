...
class DataIngestion:
    def __init__(self, data_ingetion_config:DataIngestionConfig):
        try:
    ...
    def export_collection_as_dataframe(self):
        ...
        """" this function is just to read the data"""
        try:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info("existed split_data_as_train_test method od Data_ingestion class")
